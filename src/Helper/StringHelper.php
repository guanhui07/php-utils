...
use Raylin666\Utils\Helper\String\StringChars;
...
class StringHelper
{
     ...
     * Note: Adapted from Symfony\Component\Security\Core\Utils\StringUtils.
     *
     ...
     * in will be used.
     * ##### Example
     *     echo StringHelper::random('alpha', 20);
     *     // Output:
     *     DdyQFCddSKeTkfjCewPa
     *     echo StringHelper::random('distinct', 20);
     *     // Output:
    ...
    /**
     * 数字小数点 尾0删除, 数字小于1则不处理
     * @param      $number
     * @param bool $isRound
     * @param int  $decimal
     * @return string
     */
    public static function numberDecimalPointRemove($number, $isRound = false, $decimal = 2)
    {
        if ($number < 1) {
